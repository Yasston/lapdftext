package edu.isi.bmkeg.pdf.model.ordering;
...
public class SpatialOrdering implements Comparator<SpatialEntity> {
	...
	private int camdOrdering(SpatialEntity o1, SpatialEntity o2) {
		...
		String o1Allignment = ((Block) o1).getLeftRightMedLine();
		String o2Allignment = ((Block) o2).getLeftRightMedLine();
	...
	private boolean executeHeaderFooterCheck(ChunkBlock o1, ChunkBlock o2) {
		...
		numberOfLineOne1 = o1.getNumberOfLine() == 1;
		numberofLineOne2 = o2.getNumberOfLine() == 1;
