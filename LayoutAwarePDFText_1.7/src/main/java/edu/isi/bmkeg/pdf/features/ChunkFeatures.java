...
public class ChunkFeatures {
    ...
    /**
     * returns the difference between the most popular font size in the in the
     * current chunk and the most popular font size in the document.
     *
     * @return
     */
    ...
    public String getSection() throws InvalidPopularSpaceValueException {
        ...
        while (section != null) {
            ...
            /**
             * introducing a special check to see if the call to
             * getLastChunkBlock returns the same block i.e. lastBlock if so we
             * break the loop and exit with section = lastBlock.getType()
             */
            prev = lastBlock;
    ...
    /**
     * returns true if the chunk is a sinle column centered on the page else
     * returns false
     *
     * @return
     */
